  ...
  render() {
    return (
      <Wrapper className="row">
        ...
        { !this.props.isFetching && this.props.visibleMediaItems && this.props.visibleMediaItems.map((item, i) => <MediaItem key={i} mediaItem={item} query={this.props.query} createPostSet={this.props.createPostSet} onDelete={this.props.onConfirmDelete} openPreview={this.props.openPreview} openEditor={this.props.openEditor} permissionClasses={this.props.permissionClasses} />)}
      </Wrapper>
    );
  }
}
