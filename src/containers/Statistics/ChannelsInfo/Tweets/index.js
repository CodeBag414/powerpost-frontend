...
class Tweets extends React.Component {
    ...
    getChartsData() {
        ...
        switch(this.props.activeChannel.connection.channel) {
            case 'pinterest':
                const pinterest = this.props.activeChannel.analytics.pins_by_weeks_ago;
                for(i in pinterest) {
                ...
                break;
            case 'twitter':
                const twitter = this.props.activeChannel.analytics.tweets_by_weeks_ago;
                for(i in twitter) {
                ...
                break;
            case 'facebook':
                const facebook = this.props.activeChannel.analytics.posts_by_weeks_ago;
                for(i in facebook) {
                ...
                break;
            case 'linkedin':
                const linkedin = this.props.activeChannel.analytics.posts_by_weeks_ago;
                for(i in linkedin) {
